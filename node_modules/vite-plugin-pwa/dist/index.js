...
async function generateInjectManifest(options, viteOptions) {
  ...
  const [workbox, buildSW] = await Promise.all([
    loadWorkboxBuild(),
    import("./vite-build-VYLRA7DZ.js").then(({ buildSW: buildSW2 }) => buildSW2)
  ]);
...
function resolvePWAAssetsOptions(options) {
  ...
  const configIncluded = "config" in options && options.config !== void 0 && options.config;
  const presetIncluded = "preset" in options && options.preset !== void 0 && options.preset;
