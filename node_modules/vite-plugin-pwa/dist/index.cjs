...
function resolvePWAAssetsOptions(options2) {
  ...
  const configIncluded = "config" in options2 && options2.config !== void 0 && options2.config;
  const presetIncluded = "preset" in options2 && options2.preset !== void 0 && options2.preset;
